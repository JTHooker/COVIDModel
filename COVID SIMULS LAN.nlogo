...
to adjustVirulence
  if asymptom <= asymptomaticPercentage [ set personalvirulence  personalVirulence  * .33 ]
end

to adjustGlobalVirulence
    if mean [ personalvirulence ] of simuls < Global_transmissability  [ ask n-of 10 simuls with [ personalvirulence > AsymptomaticPercentage ]  [ set personalvirulence personalvirulence + 1 ] adjustGlobalvirulence resetVirulence ] ;; virulence of asymptomatic cases is 1/3 of that of symptomatic cases
end

to resetVirulence
  let over100virus simuls with [ personalvirulence > 100 ]
  ask over100virus [ set personalvirulence random 100 ]
end
@#$#@#$#@
GRAPHICS-WINDOW
328
