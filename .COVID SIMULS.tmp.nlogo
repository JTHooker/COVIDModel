...
to resetPersonalVirulence
  if personalVirulence > 100 [ set personalVirulence random globalTransmissability 10 ]
  if personalVirulence < 0 [ set personalVirulence random globalTransmissability 10 ]
  r
end
