...
to HHContactsIso
  ifelse isolate = true and color = 85 and any? other simuls with [ householdunit = [ householdunit] of myself and tracked = 1 ] [ move-to homelocation set pace 0 set shape "star" set isolating 1 ] [  set isolating 0 ]
